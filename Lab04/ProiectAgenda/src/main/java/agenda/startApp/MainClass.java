...
/**
 * Clasa main, folosita pentru realizarea operatiilor de adaugare contact, adaugare activitate si generare raport
 */
public class MainClass {
	...
	private static void afisActivitate(RepositoryActivity activityRep,
		...
		try {
			...
			List<Activity> act = activityRep.activitiesOnDate(user.getName(), d);
			for (Activity a : act) {
